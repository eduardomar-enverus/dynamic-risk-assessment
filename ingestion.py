...
def merge_multiple_dataframe():
    ...
    final_df = final_df.drop_duplicates().reset_index(drop=True)  # dedup combined dataframe
...
def write_files(final_df, ingested_files):
    ...
    if not os.path.exists(output_folder_path):
        os.makedirs(output_folder_path)  # If ingest data directory does not exist create it
